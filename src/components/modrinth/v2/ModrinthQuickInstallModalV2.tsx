    ...
    <>
      {showQuickProfileView && project ? (
        ...
        <div className="px-6 py-4">
          <p className="text-gray-300 mb-4 text-base lowercase">
                      ...
                      >
                        <div className="text-white flex-grow mr-3 min-w-0">
                          ...
                          {isCompatible && bestVersion && (
                            <div className="text-xs text-gray-400 mt-0.5 font-minecraft lowercase truncate">
                              Will install: {bestVersion.version_number}
                            </div>
                          )}
                        </div>
