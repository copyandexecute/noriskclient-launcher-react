...
> = ({
  ...
  const totalCategoryFilters = currentSelectedCategories.length;
        ...
        >
          <div className="space-y-1 pr-1">
            <FilterOption
              label="Client"
              icon={
                <Icon icon="solar:devices-bold" className="w-4 h-4 mr-1.5" />
              }
            ...
            <FilterOption
              label="Server"
              icon={
                <Icon icon="solar:server-bold" className="w-4 h-4 mr-1.5" />
              }
